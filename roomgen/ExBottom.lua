...
function ExBottom:makeStructure(left, top,width, height,centX,centY ,reverse )
	...
	self.room:addRectangleObj("ObjLevelChanger",centX,centY + 6,8,2,{newX = self.newX,newY = self.newY,nextRoom= self.nextRoom or "Gen", dir = "down", prevY = self.prevY, prevX = self.prevX})
